...
//  Shepherd-iOS
//
//  Created by 徐栋栋 on 5/19/16.
//  Copyright © 2016 tengchong. All rights reserved.
//
...
public final class NetworkLogger: PluginType {
    ...
    public init(verbose: Bool = false, output: (items: Any..., separator: String, terminator: String) -> Void = print, responseDataFormatter: ((NSData) -> (NSData))? = nil) {
        ...
        self.loggerId = NSBundle.mainBundle().infoDictionary!["CFBundleName"] as! String
    }
